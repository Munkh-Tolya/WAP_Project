...
public class DataRepository{
	...
	public void initData() {
		...
		Product p1 = new Product(1,"ONTEC E Headset","Sample product",175,"img",10,c1);
		Product p2 = new Product(2,"Solo Headset","Sample product",235,"img",10,c1);
		Product p3 = new Product(3,"Ultra Whitte Wireless","Sample product",350,"img",10,c1);
		Product p4 = new Product(4,"Wireless Mondo","Sample product",266,"img",10,c1);
		
		Product p5 = new Product(5,"Tablet Red 8500U 2TB","Sample product",100,"img",10,c2);
		Product p6 = new Product(6,"Tablet VX3000 Extra","Sample product",850,"img",10,c2);
		Product p7 = new Product(7,"Laptop Sens 7200L","Sample product",760,"img",10,c2);
